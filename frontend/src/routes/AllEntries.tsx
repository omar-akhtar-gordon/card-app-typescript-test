    ...
    return(
        <section className="grid grid-cols-2 md:grid-cols-4">
            {entries.map((entry: Entry, index: number) => {
                return(
                    <div id={entry.id} key={index}className="bg-gray-300 shadow-md shadow-gray-500 m-3 p-4 rounded flex flex-col justify-between dark:bg-gray-600">
                        ...
                        <section className="flex items-center justify-between flex-col md:flex-row pt-2 md:pt-0 dark:text-white">
